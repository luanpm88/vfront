    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__widget">        
            @guest
                ...
                @if (Route::has('fontent.reg_step1'))
                <a href="{{ route('fontent.reg_step1') }}" style="padding-left: 29px">
                    <i class="fa fa-user-plus" aria-hidden="true"></i> {{ __('layout.signup') }}
                </a>
                @endif 
                <div class="changelanguage">
                    <a href="{{ asset('locale/en') }}">English</a> - 
                    <a href="{{ asset('locale/vn') }}" style="padding-left: 19px">Tiếng việt</a>
                </div>
            @else
            <div class="header__top__right__language">
                ...
                <ul>
                    ...
                    <li><a href="{{ asset('locale/en') }}">EN</a></li>
                    <li><a href="{{ asset('locale/vn') }}">VN</a></li>                
                </ul>
            </div>
